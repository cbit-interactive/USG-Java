...
public class WindowManager {
    ...
    private String title = "USG Java " + Versioning.Major + Versioning.Minor + Versioning.Patch;
    ...
    public void init() {
        ...
        mainWindow = GLFW.glfwCreateWindow(800, 600, title, 0, 0);
        if (mainWindow == 0) {
            throw new RuntimeException("Failed to create the GLFW window");
        }
        
        GLFW.glfwMakeContextCurrent(mainWindow);
        GLFW.glfwShowWindow(mainWindow); // Add this line
